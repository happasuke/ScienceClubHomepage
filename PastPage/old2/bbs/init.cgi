#┌──────────────────────────────────────
#│ DELUXE LIGHT BORAD v1.29 (2005.12.17)
...
$ver2 = 'D-LIGHT v1.29'; # バージョン情報（修正、削除不可）
#┌──────────────────────────────────────
#│ [注意事項・合意事項]
...
#│ 6.トリップ機能は Logue 氏(http://logue.tk/)製作、YY-BOARD Nextのものを参考
#｜   にしました。
#│ 7.荒らしログ管理機能強化のため、v1.10以降のログはv1.10以前に作成したログと
#│   互換性はありませんので、ログファイルを上書きしてください。
#│   変換スクリプトは、大幅な形式変更のため付属しておりません。
#│   あらかじめご了承ください
#│ 8.※現在こちらの携帯電話対応機能は利用できません。
#｜   携帯電話の対応状況は現在DoCoMoとVodafoneのみです。
