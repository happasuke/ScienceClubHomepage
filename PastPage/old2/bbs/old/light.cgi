...
sub viewlog {
	...
	print "[<a href=\"i_light.cgi\">携帯用</a>]";
...
<tr>
  ...
  <textarea cols=58 rows=7 name=comment wrap="soft">$recom</textarea></td>
</tr>
<tr>
  <td nowrap><b>参照先</b></td>
  <td><input type=text size=48 name=url value="$curl"></td>
</tr>
</table>
</form>
</blockquote>
...
#  <td width="85%"><input type=password name=pwd size=8 maxlength=8 value="$cpwd">
#  （記事メンテ用）</td>
#</tr>
	...
	while (<IN>) {
		...
		"<b style=\"color:$subcol\">$sub</b> 投稿者：<b>$nam</b> ",
		"投稿日：$dat &nbsp;</td><td valign=top>",
...
<br>
<span style='font-size:11px;font-family:Verdana'><!-- $ver -->
