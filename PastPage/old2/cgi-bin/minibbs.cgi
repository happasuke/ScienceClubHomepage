...
# このスクリプトをＵＲＬで設定
$reload = 'http://www.sendai-ct.ac.jp/~ckuma/kagakubu/cgi-bin/minibbs.cgi';

# 画面の「終了」ボタンの表示先をＵＲＬで設定
$modoru = 'http://www.sendai-ct.ac.jp/~ckuma/kagakubu';
...
sub html {
    ...
    print "<P ALIGN=RIGHT><FONT SIZE=+2><A HREF=\"http://www.sendai-ct.ac.jp/~ckuma/kagakubu\">トップに戻る</A></FONT></P>\n";
